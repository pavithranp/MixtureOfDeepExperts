...
from detectron2.modeling import PROPOSAL_GENERATOR_REGISTRY, ShapeSpec
...
class CustomRPN(nn.Module):
    ...
    def predict_proposals(
        ...
        with torch.no_grad():
            pred_proposals = self._decode_proposals(anchors, pred_anchor_deltas)
            return self.find_rpn_proposals(
                pred_proposals,
                pred_objectness_logits,
                image_sizes,
    ...
    def find_rpn_proposals(self,
        ...
        return topk_scores, topk_proposals, level_ids
